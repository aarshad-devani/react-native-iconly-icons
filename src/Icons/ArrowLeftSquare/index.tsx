...
const ArrowLeftSquare: FC<SvgProps & IIconProps> = (props) => {
...
export const ArrowLeftSquareBold = Bold;
export const ArrowLeftSquareBroken = Broken;
export const ArrowLeftSquareBulk = Bulk;
export const ArrowLeftSquareCurved = Curved;
export const ArrowLeftSquareLight = Light;
export const ArrowLeftSquareLightOutline = LightOutline;
export const ArrowLeftSquareTwotone = Twotone;
