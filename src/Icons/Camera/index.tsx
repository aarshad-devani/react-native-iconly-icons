...
const Camera: FC<SvgProps & IIconProps> = (props) => {
...
export const CameraBold = Bold;
export const CameraBroken = Broken;
export const CameraBulk = Bulk;
export const CameraCurved = Curved;
export const CameraLight = Light;
export const CameraLightOutline = LightOutline;
export const CameraTwotone = Twotone;
