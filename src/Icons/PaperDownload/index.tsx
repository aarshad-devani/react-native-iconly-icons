...
const PaperDownload: FC<SvgProps & IIconProps> = (props) => {
...
export const PaperDownloadBold = Bold;
export const PaperDownloadBroken = Broken;
export const PaperDownloadBulk = Bulk;
export const PaperDownloadCurved = Curved;
export const PaperDownloadLight = Light;
export const PaperDownloadLightOutline = LightOutline;
export const PaperDownloadTwotone = Twotone;
