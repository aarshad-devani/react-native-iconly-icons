...
const Edit: FC<SvgProps & IIconProps> = (props) => {
...
export default Edit;
export const EditBold = Bold;
export const EditBroken = Broken;
export const EditBulk = Bulk;
export const EditCurved = Curved;
export const EditLight = Light;
export const EditLightOutline = LightOutline;
export const EditTwotone = Twotone;
