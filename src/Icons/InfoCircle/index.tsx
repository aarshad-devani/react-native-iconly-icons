...
const InfoCircle: FC<SvgProps & IIconProps> = (props) => {
...
export const InfoCircleBold = Bold;
export const InfoCircleBroken = Broken;
export const InfoCircleBulk = Bulk;
export const InfoCircleTwotone = Twotone;
