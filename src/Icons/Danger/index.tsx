...
const Danger: FC<SvgProps & IIconProps> = (props) => {
...
export const DangerBold = Bold;
export const DangerBroken = Broken;
export const DangerBulk = Bulk;
export const DangerTwotone = Twotone;
