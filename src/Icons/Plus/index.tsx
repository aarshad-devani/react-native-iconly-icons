...
const Plus: FC<SvgProps & IIconProps> = (props) => {
...
export default Plus;
export const PlusBold = Bold;
export const PlusBroken = Broken;
export const PlusBulk = Bulk;
export const PlusCurved = Curved;
export const PlusLight = Light;
export const PlusLightOutline = LightOutline;
export const PlusTwotone = Twotone;
