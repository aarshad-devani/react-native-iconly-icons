...
const Folder: FC<SvgProps & IIconProps> = (props) => {
...
export const FolderBold = Bold;
export const FolderBroken = Broken;
export const FolderBulk = Bulk;
export const FolderCurved = Curved;
export const FolderLight = Light;
export const FolderLightOutline = LightOutline;
export const FolderTwotone = Twotone;
