...
const VolumeDownBulk = (props: SvgProps & { fillColor: string }) => (
  <Svg width={24} height={24} fill="none" {...props}>
    ...
    <Path
      opacity={0.4}
      d="M19.426 6.495a.91.91 0 0 0-1.278-.237.955.955 0 0 0-.23 1.308c.803 1.183 1.245 2.757 1.245 4.434 0 1.676-.442 3.251-1.245 4.434a.955.955 0 0 0 .23 1.308c.154.11.336.167.524.167a.915.915 0 0 0 .754-.403C20.441 16.012 21 14.057 21 12c0-2.057-.56-4.012-1.574-5.505"
      fill={props.fillColor}
    />
  </Svg>
)
export default VolumeDownBulk
