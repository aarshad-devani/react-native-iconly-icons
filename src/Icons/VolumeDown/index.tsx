...
const VolumeDown: FC<SvgProps & IIconProps> = (props) => {
...
export const VolumeDownBold = Bold;
export const VolumeDownBroken = Broken;
export const VolumeDownBulk = Bulk;
export const VolumeDownCurved = Curved;
export const VolumeDownLight = Light;
export const VolumeDownLightOutline = LightOutline;
export const VolumeDownTwotone = Twotone;
