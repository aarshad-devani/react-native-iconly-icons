...
const ArrowRight: FC<SvgProps & IIconProps> = (props) => {
...
export const ArrowRightBold = Bold;
export const ArrowRightBroken = Broken;
export const ArrowRightBulk = Bulk;
export const ArrowRightCurved = Curved;
export const ArrowRightLight = Light;
export const ArrowRightLightOutline = LightOutline;
export const ArrowRightTwotone = Twotone;
