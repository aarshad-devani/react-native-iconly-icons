...
const Download: FC<SvgProps & IIconProps> = (props) => {
...
export const DownloadBold = Bold;
export const DownloadBroken = Broken;
export const DownloadBulk = Bulk;
export const DownloadCurved = Curved;
export const DownloadLight = Light;
export const DownloadLightOutline = LightOutline;
export const DownloadTwotone = Twotone;
