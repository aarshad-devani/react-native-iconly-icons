...
const Graph: FC<SvgProps & IIconProps> = (props) => {
...
export const GraphBold = Bold;
export const GraphBroken = Broken;
export const GraphBulk = Bulk;
export const GraphCurved = Curved;
export const GraphLight = Light;
export const GraphLightOutline = LightOutline;
export const GraphTwotone = Twotone;
