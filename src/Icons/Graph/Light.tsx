...
const GraphLight = (props: SvgProps & { fillColor: string }) => (
  <Svg width={24} height={24} fill="none" {...props}>
    ...
    <Path
      clipRule="evenodd"
      d="M21.693 9.952c.053-3.038-3.678-7.935-8.226-7.851a.679.679 0 0 0-.652.654c-.115 2.498.04 5.734.126 7.202a.89.89 0 0 0 .841.842c1.508.086 4.863.204 7.325-.168a.694.694 0 0 0 .586-.68Z"
      stroke={props.fillColor}
      strokeWidth={1.5}
      strokeLinecap="round"
      strokeLinejoin="round"
