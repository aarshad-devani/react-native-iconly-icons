...
const VolumeOff: FC<SvgProps & IIconProps> = (props) => {
...
export const VolumeOffBold = Bold;
export const VolumeOffBroken = Broken;
export const VolumeOffBulk = Bulk;
export const VolumeOffCurved = Curved;
export const VolumeOffLight = Light;
export const VolumeOffLightOutline = LightOutline;
export const VolumeOffTwotone = Twotone;
