...
const Unlock: FC<SvgProps & IIconProps> = (props) => {
...
export const UnlockBold = Bold;
export const UnlockBroken = Broken;
export const UnlockBulk = Bulk;
export const UnlockCurved = Curved;
export const UnlockLight = Light;
export const UnlockLightOutline = LightOutline;
export const UnlockTwotone = Twotone;
