...
const Heart: FC<SvgProps & IIconProps> = (props) => {
...
export const HeartBold = Bold;
export const HeartBroken = Broken;
export const HeartBulk = Bulk;
export const HeartCurved = Curved;
export const HeartLight = Light;
export const HeartLightOutline = LightOutline;
export const HeartTwotone = Twotone;
