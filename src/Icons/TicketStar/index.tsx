...
const TicketStar: FC<SvgProps & IIconProps> = (props) => {
...
export const TicketStarBold = Bold;
export const TicketStarBroken = Broken;
export const TicketStarBulk = Bulk;
export const TicketStarCurved = Curved;
export const TicketStarLight = Light;
export const TicketStarLightOutline = LightOutline;
export const TicketStarTwotone = Twotone;
