...
const Show: FC<SvgProps & IIconProps> = (props) => {
...
export default Show;
export const ShowBold = Bold;
export const ShowBroken = Broken;
export const ShowBulk = Bulk;
export const ShowCurved = Curved;
export const ShowLight = Light;
export const ShowLightOutline = LightOutline;
export const ShowTwotone = Twotone;
