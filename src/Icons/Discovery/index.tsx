...
const Discovery: FC<SvgProps & IIconProps> = (props) => {
...
export const DiscoveryBold = Bold;
export const DiscoveryBroken = Broken;
export const DiscoveryBulk = Bulk;
export const DiscoveryCurved = Curved;
export const DiscoveryLight = Light;
export const DiscoveryLightOutline = LightOutline;
export const DiscoveryTwotone = Twotone;
