...
const Calendar: FC<SvgProps & IIconProps> = (props) => {
...
export const CalendarBold = Bold;
export const CalendarBroken = Broken;
export const CalendarBulk = Bulk;
export const CalendarCurved = Curved;
export const CalendarLight = Light;
export const CalendarLightOutline = LightOutline;
export const CalendarTwotone = Twotone;
