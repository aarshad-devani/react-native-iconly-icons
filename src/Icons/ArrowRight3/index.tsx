...
const ArrowRight3: FC<SvgProps & IIconProps> = (props) => {
...
export const ArrowRight3Bold = Bold;
export const ArrowRight3Broken = Broken;
export const ArrowRight3Bulk = Bulk;
export const ArrowRight3Curved = Curved;
export const ArrowRight3Light = Light;
export const ArrowRight3LightOutline = LightOutline;
export const ArrowRight3Twotone = Twotone;
