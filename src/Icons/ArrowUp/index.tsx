...
const ArrowUp: FC<SvgProps & IIconProps> = (props) => {
...
export const ArrowUpBold = Bold;
export const ArrowUpBroken = Broken;
export const ArrowUpBulk = Bulk;
export const ArrowUpCurved = Curved;
export const ArrowUpLight = Light;
export const ArrowUpLightOutline = LightOutline;
export const ArrowUpTwotone = Twotone;
