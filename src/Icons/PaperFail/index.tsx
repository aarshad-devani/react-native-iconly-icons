...
const PaperFail: FC<SvgProps & IIconProps> = (props) => {
...
export const PaperFailBold = Bold;
export const PaperFailBroken = Broken;
export const PaperFailBulk = Bulk;
export const PaperFailCurved = Curved;
export const PaperFailLight = Light;
export const PaperFailLightOutline = LightOutline;
export const PaperFailTwotone = Twotone;
