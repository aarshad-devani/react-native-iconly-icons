...
const Video: FC<SvgProps & IIconProps> = (props) => {
...
export const VideoBold = Bold;
export const VideoBroken = Broken;
export const VideoBulk = Bulk;
export const VideoCurved = Curved;
export const VideoLight = Light;
export const VideoLightOutline = LightOutline;
export const VideoTwotone = Twotone;
