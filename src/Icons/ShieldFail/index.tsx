...
const ShieldFail: FC<SvgProps & IIconProps> = (props) => {
...
export const ShieldFailBold = Bold;
export const ShieldFailBroken = Broken;
export const ShieldFailBulk = Bulk;
export const ShieldFailCurved = Curved;
export const ShieldFailLight = Light;
export const ShieldFailLightOutline = LightOutline;
export const ShieldFailTwotone = Twotone;
