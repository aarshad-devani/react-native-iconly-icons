...
const CallSilent: FC<SvgProps & IIconProps> = (props) => {
...
export const CallSilentBold = Bold;
export const CallSilentBroken = Broken;
export const CallSilentBulk = Bulk;
export const CallSilentCurved = Curved;
export const CallSilentLight = Light;
export const CallSilentLightOutline = LightOutline;
export const CallSilentTwotone = Twotone;
