...
const Call: FC<SvgProps & IIconProps> = (props) => {
...
export default Call;
export const CallBold = Bold;
export const CallBroken = Broken;
export const CallBulk = Bulk;
export const CallCurved = Curved;
export const CallLight = Light;
export const CallLightOutline = LightOutline;
export const CallTwotone = Twotone;
