...
const Login: FC<SvgProps & IIconProps> = (props) => {
...
export const LoginBold = Bold;
export const LoginBroken = Broken;
export const LoginBulk = Bulk;
export const LoginCurved = Curved;
export const LoginLight = Light;
export const LoginLightOutline = LightOutline;
export const LoginTwotone = Twotone;
