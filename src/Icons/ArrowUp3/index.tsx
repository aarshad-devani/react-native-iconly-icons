...
const ArrowUp3: FC<SvgProps & IIconProps> = (props) => {
...
export const ArrowUp3Bold = Bold;
export const ArrowUp3Broken = Broken;
export const ArrowUp3Bulk = Bulk;
export const ArrowUp3Curved = Curved;
export const ArrowUp3Light = Light;
export const ArrowUp3LightOutline = LightOutline;
export const ArrowUp3Twotone = Twotone;
