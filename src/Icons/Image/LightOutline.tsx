...
const ImageLightOutline = (props: SvgProps & { fillColor: string }) => (
  <Svg width={24} height={24} fill="none" {...props}>
    <Mask id="a" maskUnits="userSpaceOnUse" x={2} y={2} width={20} height={20}>
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M2 2h19.96v19.95H2V2Z"
        fill="#fff"
      />
    </Mask>
    <G mask="url(#a)">
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M7.65 3.5C5.13 3.5 3.5 5.227 3.5 7.899v8.152c0 2.673 1.63 4.399 4.15 4.399h8.65c2.527 0 4.16-1.726 4.16-4.399V7.899c0-2.672-1.633-4.399-4.16-4.399H7.65Zm8.65 18.45H7.65C4.27 21.95 2 19.579 2 16.051V7.899C2 4.371 4.27 2 7.65 2h8.65c3.386 0 5.66 2.371 5.66 5.899v8.152c0 3.528-2.274 5.899-5.66 5.899Z"
