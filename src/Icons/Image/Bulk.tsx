...
const ImageBulk = (props: SvgProps & { fillColor: string }) => (
  <Svg width={24} height={24} fill="none" {...props}>
    ...
    <Path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M11.245 8.675A2.488 2.488 0 0 1 8.76 11.16a2.487 2.487 0 0 1-2.485-2.485A2.488 2.488 0 0 1 8.76 6.189a2.489 2.489 0 0 1 2.485 2.486Zm8.156 5.413c.233.226.4.484.51.759.332.832.16 1.832-.197 2.656a3.638 3.638 0 0 1-2.247 2.046 4.578 4.578 0 0 1-1.4.207h-8.38c-.835 0-1.573-.194-2.178-.558-.379-.228-.446-.753-.165-1.095.47-.57.934-1.142 1.402-1.72.892-1.103 1.493-1.423 2.162-1.142.27.116.543.29.822.475.746.494 1.784 1.172 3.15.436.933-.511 1.475-1.385 1.947-2.145l.01-.015.094-.153c.16-.26.319-.514.498-.75.221-.29 1.045-1.2 2.11-.552.68.408 1.25.96 1.861 1.55Z"
      fill={props.fillColor}
    />
  </Svg>
)
