...
const Image: FC<SvgProps & IIconProps> = (props) => {
...
export const ImageBold = Bold;
export const ImageBroken = Broken;
export const ImageBulk = Bulk;
export const ImageCurved = Curved;
export const ImageLight = Light;
export const ImageLightOutline = LightOutline;
export const ImageTwotone = Twotone;
