...
const TimeCircle: FC<SvgProps & IIconProps> = (props) => {
...
export const TimeCircleBold = Bold;
export const TimeCircleBroken = Broken;
export const TimeCircleBulk = Bulk;
export const TimeCircleCurved = Curved;
export const TimeCircleLight = Light;
export const TimeCircleLightOutline = LightOutline;
export const TimeCircleTwotone = Twotone;
