...
const Ticket: FC<SvgProps & IIconProps> = (props) => {
...
export const TicketBold = Bold;
export const TicketBroken = Broken;
export const TicketBulk = Bulk;
export const TicketCurved = Curved;
export const TicketLight = Light;
export const TicketLightOutline = LightOutline;
export const TicketTwotone = Twotone;
