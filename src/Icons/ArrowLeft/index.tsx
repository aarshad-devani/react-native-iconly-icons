...
const ArrowLeft: FC<SvgProps & IIconProps> = (props) => {
...
export const ArrowLeftBold = Bold;
export const ArrowLeftBroken = Broken;
export const ArrowLeftBulk = Bulk;
export const ArrowLeftCurved = Curved;
export const ArrowLeftLight = Light;
export const ArrowLeftLightOutline = LightOutline;
export const ArrowLeftTwotone = Twotone;
