...
const MoreSquare: FC<SvgProps & IIconProps> = (props) => {
...
export const MoreSquareBold = Bold;
export const MoreSquareBroken = Broken;
export const MoreSquareBulk = Bulk;
export const MoreSquareCurved = Curved;
export const MoreSquareLight = Light;
export const MoreSquareLightOutline = LightOutline;
export const MoreSquareTwotone = Twotone;
