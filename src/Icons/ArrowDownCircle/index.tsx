...
const ArrowDownCircle: FC<SvgProps & IIconProps> = (props) => {
...
export const ArrowDownCircleBold = Bold;
export const ArrowDownCircleBroken = Broken;
export const ArrowDownCircleBulk = Bulk;
export const ArrowDownCircleCurved = Curved;
export const ArrowDownCircleLight = Light;
export const ArrowDownCircleLightOutline = LightOutline;
export const ArrowDownCircleTwotone = Twotone;
