...
const Message: FC<SvgProps & IIconProps> = (props) => {
...
export const MessageBold = Bold;
export const MessageBroken = Broken;
export const MessageBulk = Bulk;
export const MessageCurved = Curved;
export const MessageLight = Light;
export const MessageLightOutline = LightOutline;
export const MessageTwotone = Twotone;
