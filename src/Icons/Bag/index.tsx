...
const Bag: FC<SvgProps & IIconProps> = (props) => {
...
export default Bag;
export const BagBold = Bold;
export const BagBroken = Broken;
export const BagBulk = Bulk;
export const BagCurved = Curved;
export const BagLight = Light;
export const BagLightOutline = LightOutline;
export const BagTwotone = Twotone;
