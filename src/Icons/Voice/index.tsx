...
const Voice: FC<SvgProps & IIconProps> = (props) => {
...
export const VoiceBold = Bold;
export const VoiceBroken = Broken;
export const VoiceBulk = Bulk;
export const VoiceCurved = Curved;
export const VoiceLight = Light;
export const VoiceLightOutline = LightOutline;
export const VoiceTwotone = Twotone;
