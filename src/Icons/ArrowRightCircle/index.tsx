...
const ArrowRightCircle: FC<SvgProps & IIconProps> = (props) => {
...
export const ArrowRightCircleBold = Bold;
export const ArrowRightCircleBroken = Broken;
export const ArrowRightCircleBulk = Bulk;
export const ArrowRightCircleCurved = Curved;
export const ArrowRightCircleLight = Light;
export const ArrowRightCircleLightOutline = LightOutline;
export const ArrowRightCircleTwotone = Twotone;
