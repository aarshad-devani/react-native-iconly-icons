...
const Send: FC<SvgProps & IIconProps> = (props) => {
...
export default Send;
export const SendBold = Bold;
export const SendBroken = Broken;
export const SendBulk = Bulk;
export const SendCurved = Curved;
export const SendLight = Light;
export const SendLightOutline = LightOutline;
export const SendTwotone = Twotone;
