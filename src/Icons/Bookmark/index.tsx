...
const Bookmark: FC<SvgProps & IIconProps> = (props) => {
...
export const BookmarkBold = Bold;
export const BookmarkBroken = Broken;
export const BookmarkBulk = Bulk;
export const BookmarkCurved = Curved;
export const BookmarkLight = Light;
export const BookmarkLightOutline = LightOutline;
export const BookmarkTwotone = Twotone;
