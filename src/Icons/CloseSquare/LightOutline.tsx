...
const CloseSquareLightOutline = (props: SvgProps & { fillColor: string }) => (
  <Svg width={24} height={24} fill="none" {...props}>
    <G fillRule="evenodd" clipRule="evenodd" fill={props.fillColor}>
      <Path d="M9.603 15.137a.749.749 0 0 1-.53-1.28l4.791-4.792a.749.749 0 1 1 1.06 1.06l-4.791 4.792a.744.744 0 0 1-.53.22" />
      <Path d="M14.397 15.14a.744.744 0 0 1-.53-.22L9.07 10.123a.749.749 0 1 1 1.06-1.06l4.796 4.797a.749.749 0 0 1-.53 1.28" />
...
export default CloseSquareLightOutline
