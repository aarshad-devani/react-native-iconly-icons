...
const CloseSquare: FC<SvgProps & IIconProps> = (props) => {
...
export const CloseSquareBold = Bold;
export const CloseSquareBroken = Broken;
export const CloseSquareBulk = Bulk;
export const CloseSquareCurved = Curved;
export const CloseSquareLight = Light;
export const CloseSquareLightOutline = LightOutline;
export const CloseSquareTwotone = Twotone;
