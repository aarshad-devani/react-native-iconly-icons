...
const AddUser: FC<SvgProps & IIconProps> = (props) => {
...
export const AddUserBold = Bold;
export const AddUserBroken = Broken;
export const AddUserBulk = Bulk;
export const AddUserCurved = Curved;
export const AddUserLight = Light;
export const AddUserLightOutline = LightOutline;
export const AddUserTwotone = Twotone;
