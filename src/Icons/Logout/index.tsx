...
const Logout: FC<SvgProps & IIconProps> = (props) => {
...
export const LogoutBold = Bold;
export const LogoutBroken = Broken;
export const LogoutBulk = Bulk;
export const LogoutCurved = Curved;
export const LogoutLight = Light;
export const LogoutLightOutline = LightOutline;
export const LogoutTwotone = Twotone;
