...
const ArrowDown3: FC<SvgProps & IIconProps> = (props) => {
...
export const ArrowDown3Bold = Bold;
export const ArrowDown3Broken = Broken;
export const ArrowDown3Bulk = Bulk;
export const ArrowDown3Curved = Curved;
export const ArrowDown3Light = Light;
export const ArrowDown3LightOutline = LightOutline;
export const ArrowDown3Twotone = Twotone;
