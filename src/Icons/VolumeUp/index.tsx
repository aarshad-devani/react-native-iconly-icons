...
const VolumeUp: FC<SvgProps & IIconProps> = (props) => {
...
export const VolumeUpBold = Bold;
export const VolumeUpBroken = Broken;
export const VolumeUpBulk = Bulk;
export const VolumeUpCurved = Curved;
export const VolumeUpLight = Light;
export const VolumeUpLightOutline = LightOutline;
export const VolumeUpTwotone = Twotone;
