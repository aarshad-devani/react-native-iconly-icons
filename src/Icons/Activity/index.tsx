...
const Activity: FC<SvgProps & IIconProps> = (props) => {
...
export const ActivityBold = Bold;
export const ActivityBroken = Broken;
export const ActivityBulk = Bulk;
export const ActivityCurved = Curved;
export const ActivityLight = Light;
export const ActivityLightOutline = LightOutline;
export const ActivityTwotone = Twotone;
