...
const User3: FC<SvgProps & IIconProps> = (props) => {
...
export const User3Bold = Bold;
export const User3Broken = Broken;
export const User3Bulk = Bulk;
export const User3Curved = Curved;
export const User3Light = Light;
export const User3LightOutline = LightOutline;
export const User3Twotone = Twotone;
