...
const Home: FC<SvgProps & IIconProps> = (props) => {
...
export default Home;
export const HomeBold = Bold;
export const HomeBroken = Broken;
export const HomeBulk = Bulk;
export const HomeCurved = Curved;
export const HomeLight = Light;
export const HomeLightOutline = LightOutline;
export const HomeTwotone = Twotone;
