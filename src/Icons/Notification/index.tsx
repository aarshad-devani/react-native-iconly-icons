...
const Notification: FC<SvgProps & IIconProps> = (props) => {
...
export const NotificationBold = Bold;
export const NotificationBroken = Broken;
export const NotificationBulk = Bulk;
export const NotificationCurved = Curved;
export const NotificationLight = Light;
export const NotificationLightOutline = LightOutline;
export const NotificationTwotone = Twotone;
