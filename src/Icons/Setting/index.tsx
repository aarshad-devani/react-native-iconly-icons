...
const Setting: FC<SvgProps & IIconProps> = (props) => {
...
export const SettingBold = Bold;
export const SettingBroken = Broken;
export const SettingBulk = Bulk;
export const SettingCurved = Curved;
export const SettingLight = Light;
export const SettingLightOutline = LightOutline;
export const SettingTwotone = Twotone;
