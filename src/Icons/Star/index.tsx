...
const Star: FC<SvgProps & IIconProps> = (props) => {
...
export default Star;
export const StarBold = Bold;
export const StarBroken = Broken;
export const StarBulk = Bulk;
export const StarCurved = Curved;
export const StarLight = Light;
export const StarLightOutline = LightOutline;
export const StarTwotone = Twotone;
