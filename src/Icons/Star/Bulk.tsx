...
const StarBulk = (props: SvgProps & { fillColor: string }) => (
  <Svg width={24} height={24} fill="none" {...props}>
    ...
    />
    <Path
      d="M11.992 18.917a1.227 1.227 0 0 0-.552.151L7 21.388a1.158 1.158 0 0 1-1.497-.462 1.106 1.106 0 0 1-.116-.694l.887-4.929c.06-.358-.06-.722-.32-.975l-3.626-3.51a1.093 1.093 0 0 1-.017-1.544l.017-.016c.172-.17.393-.282.632-.317l5.005-.737c.363-.046.677-.272.837-.6l2.176-4.54A1.105 1.105 0 0 1 12 2.501c-.008.297-.008 16.213-.008 16.415"
      fill={props.fillColor}
    />
  </Svg>
)
