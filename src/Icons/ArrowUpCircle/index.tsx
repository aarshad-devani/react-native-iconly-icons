...
const ArrowUpCircle: FC<SvgProps & IIconProps> = (props) => {
...
export const ArrowUpCircleBold = Bold;
export const ArrowUpCircleBroken = Broken;
export const ArrowUpCircleBulk = Bulk;
export const ArrowUpCircleCurved = Curved;
export const ArrowUpCircleLight = Light;
export const ArrowUpCircleLightOutline = LightOutline;
export const ArrowUpCircleTwotone = Twotone;
