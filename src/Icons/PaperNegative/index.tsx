...
const PaperNegative: FC<SvgProps & IIconProps> = (props) => {
...
export const PaperNegativeBold = Bold;
export const PaperNegativeBroken = Broken;
export const PaperNegativeBulk = Bulk;
export const PaperNegativeCurved = Curved;
export const PaperNegativeLight = Light;
export const PaperNegativeLightOutline = LightOutline;
export const PaperNegativeTwotone = Twotone;
