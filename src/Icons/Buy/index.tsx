...
const Buy: FC<SvgProps & IIconProps> = (props) => {
...
export default Buy;
export const BuyBold = Bold;
export const BuyBroken = Broken;
export const BuyBulk = Bulk;
export const BuyCurved = Curved;
export const BuyLight = Light;
export const BuyLightOutline = LightOutline;
export const BuyTwotone = Twotone;
