...
const EditSquare: FC<SvgProps & IIconProps> = (props) => {
...
export const EditSquareBold = Bold;
export const EditSquareBroken = Broken;
export const EditSquareBulk = Bulk;
export const EditSquareCurved = Curved;
export const EditSquareLight = Light;
export const EditSquareLightOutline = LightOutline;
export const EditSquareTwotone = Twotone;
