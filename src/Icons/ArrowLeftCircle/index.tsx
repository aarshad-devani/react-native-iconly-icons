...
const ArrowLeftCircle: FC<SvgProps & IIconProps> = (props) => {
...
export const ArrowLeftCircleBold = Bold;
export const ArrowLeftCircleBroken = Broken;
export const ArrowLeftCircleBulk = Bulk;
export const ArrowLeftCircleCurved = Curved;
export const ArrowLeftCircleLight = Light;
export const ArrowLeftCircleLightOutline = LightOutline;
export const ArrowLeftCircleTwotone = Twotone;
