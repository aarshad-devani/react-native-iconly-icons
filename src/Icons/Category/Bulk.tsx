...
const CategoryBulk = (props: SvgProps & { fillColor: string }) => (
  <Svg width={24} height={24} fill="none" {...props}>
    <Path
      opacity={0.4}
      d="M16.075 2h3.386A2.549 2.549 0 0 1 22 4.56v3.415a2.549 2.549 0 0 1-2.539 2.56h-3.386a2.549 2.549 0 0 1-2.538-2.56V4.56A2.549 2.549 0 0 1 16.075 2"
