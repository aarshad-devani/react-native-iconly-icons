...
const Calling: FC<SvgProps & IIconProps> = (props) => {
...
export const CallingBold = Bold;
export const CallingBroken = Broken;
export const CallingBulk = Bulk;
export const CallingCurved = Curved;
export const CallingLight = Light;
export const CallingLightOutline = LightOutline;
export const CallingTwotone = Twotone;
