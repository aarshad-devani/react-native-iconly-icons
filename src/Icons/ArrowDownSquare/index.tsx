...
const ArrowDownSquare: FC<SvgProps & IIconProps> = (props) => {
...
export const ArrowDownSquareBold = Bold;
export const ArrowDownSquareBroken = Broken;
export const ArrowDownSquareBulk = Bulk;
export const ArrowDownSquareCurved = Curved;
export const ArrowDownSquareLight = Light;
export const ArrowDownSquareLightOutline = LightOutline;
export const ArrowDownSquareTwotone = Twotone;
