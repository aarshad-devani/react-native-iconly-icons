...
const Location: FC<SvgProps & IIconProps> = (props) => {
...
export const LocationBold = Bold;
export const LocationBroken = Broken;
export const LocationBulk = Bulk;
export const LocationCurved = Curved;
export const LocationLight = Light;
export const LocationLightOutline = LightOutline;
export const LocationTwotone = Twotone;
