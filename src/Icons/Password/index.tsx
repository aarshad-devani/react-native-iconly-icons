...
const Password: FC<SvgProps & IIconProps> = (props) => {
...
export const PasswordBold = Bold;
export const PasswordBroken = Broken;
export const PasswordBulk = Bulk;
export const PasswordCurved = Curved;
export const PasswordLight = Light;
export const PasswordLightOutline = LightOutline;
export const PasswordTwotone = Twotone;
