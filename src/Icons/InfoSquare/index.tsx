...
const InfoSquare: FC<SvgProps & IIconProps> = (props) => {
...
export const InfoSquareBold = Bold;
export const InfoSquareBroken = Broken;
export const InfoSquareBulk = Bulk;
export const InfoSquareCurved = Curved;
export const InfoSquareLight = Light;
export const InfoSquareLightOutline = LightOutline;
export const InfoSquareTwotone = Twotone;
