...
const Discount: FC<SvgProps & IIconProps> = (props) => {
...
export const DiscountBold = Bold;
export const DiscountBroken = Broken;
export const DiscountBulk = Bulk;
export const DiscountCurved = Curved;
export const DiscountLight = Light;
export const DiscountLightOutline = LightOutline;
export const DiscountTwotone = Twotone;
