...
const ShieldDone: FC<SvgProps & IIconProps> = (props) => {
...
export const ShieldDoneBold = Bold;
export const ShieldDoneBroken = Broken;
export const ShieldDoneBulk = Bulk;
export const ShieldDoneCurved = Curved;
export const ShieldDoneLight = Light;
export const ShieldDoneLightOutline = LightOutline;
export const ShieldDoneTwotone = Twotone;
