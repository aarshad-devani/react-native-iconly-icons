...
const ArrowDown: FC<SvgProps & IIconProps> = (props) => {
...
export const ArrowDownBold = Bold;
export const ArrowDownBroken = Broken;
export const ArrowDownBulk = Bulk;
export const ArrowDownCurved = Curved;
export const ArrowDownLight = Light;
export const ArrowDownLightOutline = LightOutline;
export const ArrowDownTwotone = Twotone;
