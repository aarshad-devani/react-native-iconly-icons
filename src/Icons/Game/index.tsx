...
const Game: FC<SvgProps & IIconProps> = (props) => {
...
export default Game;
export const GameBold = Bold;
export const GameBroken = Broken;
export const GameBulk = Bulk;
export const GameCurved = Curved;
export const GameLight = Light;
export const GameLightOutline = LightOutline;
export const GameTwotone = Twotone;
