...
const PaperPlus: FC<SvgProps & IIconProps> = (props) => {
...
export const PaperPlusBold = Bold;
export const PaperPlusBroken = Broken;
export const PaperPlusBulk = Bulk;
export const PaperPlusCurved = Curved;
export const PaperPlusLight = Light;
export const PaperPlusLightOutline = LightOutline;
export const PaperPlusTwotone = Twotone;
