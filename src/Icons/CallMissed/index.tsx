...
const CallMissed: FC<SvgProps & IIconProps> = (props) => {
...
export const CallMissedBold = Bold;
export const CallMissedBroken = Broken;
export const CallMissedBulk = Bulk;
export const CallMissedCurved = Curved;
export const CallMissedLight = Light;
export const CallMissedLightOutline = LightOutline;
export const CallMissedTwotone = Twotone;
