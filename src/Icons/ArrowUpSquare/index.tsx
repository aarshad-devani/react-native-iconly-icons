...
const ArrowUpSquare: FC<SvgProps & IIconProps> = (props) => {
...
export const ArrowUpSquareBold = Bold;
export const ArrowUpSquareBroken = Broken;
export const ArrowUpSquareBulk = Bulk;
export const ArrowUpSquareCurved = Curved;
export const ArrowUpSquareLight = Light;
export const ArrowUpSquareLightOutline = LightOutline;
export const ArrowUpSquareTwotone = Twotone;
