...
const PaperBulk = (props: SvgProps & { fillColor: string }) => (
  <Svg width={24} height={24} fill="none" {...props}>
    ...
    <Path
      opacity={0.4}
      d="M16.084 2.567a.477.477 0 0 0-.821.334v2.637c0 1.106.91 2.016 2.017 2.016.697.008 1.665.01 2.487.008a.477.477 0 0 0 .343-.808l-4.026-4.187"
      fill={props.fillColor}
    />
    <Path
      fillRule="evenodd"
