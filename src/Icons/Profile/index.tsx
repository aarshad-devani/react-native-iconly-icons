...
const Profile: FC<SvgProps & IIconProps> = (props) => {
...
export const ProfileBold = Bold;
export const ProfileBroken = Broken;
export const ProfileBulk = Bulk;
export const ProfileCurved = Curved;
export const ProfileLight = Light;
export const ProfileLightOutline = LightOutline;
export const ProfileTwotone = Twotone;
