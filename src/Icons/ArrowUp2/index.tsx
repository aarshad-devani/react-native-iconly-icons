...
const ArrowUp2: FC<SvgProps & IIconProps> = (props) => {
...
export const ArrowUp2Bold = Bold;
export const ArrowUp2Broken = Broken;
export const ArrowUp2Bulk = Bulk;
export const ArrowUp2Curved = Curved;
export const ArrowUp2Light = Light;
export const ArrowUp2LightOutline = LightOutline;
export const ArrowUp2Twotone = Twotone;
