...
const ArrowRightSquare: FC<SvgProps & IIconProps> = (props) => {
...
export const ArrowRightSquareBold = Bold;
export const ArrowRightSquareBroken = Broken;
export const ArrowRightSquareBulk = Bulk;
export const ArrowRightSquareCurved = Curved;
export const ArrowRightSquareLight = Light;
export const ArrowRightSquareLightOutline = LightOutline;
export const ArrowRightSquareTwotone = Twotone;
