...
const Wallet: FC<SvgProps & IIconProps> = (props) => {
...
export const WalletBold = Bold;
export const WalletBroken = Broken;
export const WalletBulk = Bulk;
export const WalletCurved = Curved;
export const WalletLight = Light;
export const WalletLightOutline = LightOutline;
export const WalletTwotone = Twotone;
