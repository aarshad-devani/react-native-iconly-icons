...
const MoreCircle: FC<SvgProps & IIconProps> = (props) => {
...
export const MoreCircleBold = Bold;
export const MoreCircleBroken = Broken;
export const MoreCircleBulk = Bulk;
export const MoreCircleCurved = Curved;
export const MoreCircleLight = Light;
export const MoreCircleLightOutline = LightOutline;
export const MoreCircleTwotone = Twotone;
