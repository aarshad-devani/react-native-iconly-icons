...
const TickSquare: FC<SvgProps & IIconProps> = (props) => {
...
export const TickSquareBold = Bold;
export const TickSquareBroken = Broken;
export const TickSquareBulk = Bulk;
export const TickSquareCurved = Curved;
export const TickSquareLight = Light;
export const TickSquareLightOutline = LightOutline;
export const TickSquareTwotone = Twotone;
