...
const PaperUpload: FC<SvgProps & IIconProps> = (props) => {
...
export const PaperUploadBold = Bold;
export const PaperUploadBroken = Broken;
export const PaperUploadBulk = Bulk;
export const PaperUploadCurved = Curved;
export const PaperUploadLight = Light;
export const PaperUploadLightOutline = LightOutline;
export const PaperUploadTwotone = Twotone;
