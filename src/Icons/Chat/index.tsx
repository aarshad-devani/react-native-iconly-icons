...
const Chat: FC<SvgProps & IIconProps> = (props) => {
...
export default Chat;
export const ChatBold = Bold;
export const ChatBroken = Broken;
export const ChatBulk = Bulk;
export const ChatCurved = Curved;
export const ChatLight = Light;
export const ChatLightOutline = LightOutline;
export const ChatTwotone = Twotone;
